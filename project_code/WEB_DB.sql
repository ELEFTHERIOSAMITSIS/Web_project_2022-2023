...
INSERT INTO User(Username, Pass, Email, First_Name, Last_Name) Values
('lefteris', 123, 'lefteris@mail.com', 'Lefteris', 'Amitsis'),
('sarantis', 456, 'sarantis@mail.com', 'Sarantis', 'Papachristofilou');
INSERT INTO User(Username, Pass, Email, First_Name, Last_Name, adminstrator) Values
('xaris',    789, 'xaris@gmail.com',   'Xaris',    'Pissouros', 'admin');
...
SELECT * FROM User;
DELETE FROM LikesDislikes;
Select * from Products;
Select * from Offers;
Select * from Prices;
SELECT * from Sunolika_Tokens;
DELETE FROM Offers;
